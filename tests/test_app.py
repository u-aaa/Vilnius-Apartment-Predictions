...
from app.app import process_input, predict_price

single_input = [{"division": "Baltupiai", "no_of_rooms": 1, "area": 35, "floor": 2, "no_of_floors": 5,
                 "build_year": 2021, "building_type": "Brick", "nearest_kindergarten": 80,
                 "nearest_educational_institution": 170.0, "nearest_shop": 490.0, "public_transport_stop": 240.0
                 }]
single_wrong_input = [{"division": "Baltupiai", "no_of_rooms": 'one', "area": 35, "floor": 2, "no_of_floors": 5,
                 "build_year": 2021, "building_type": "Brick", "nearest_kindergarten": 80,
                 "nearest_educational_institution": 170.0, "nearest_shop": 490.0, "public_transport_stop": 240.0
                 }]

double_input = [{"division": "Karoliniškės", "area": 68.3, "no_of_rooms": 3, "build_year": 1977, "floor": 5,
                ...
                {"division": "Pilaitė", "area": 50, "no_of_rooms": 2, "build_year": 1994, "floor": 9,
...
incomplete_data = [{"division": "Šnipiškės", "area": 71.78, "no_of_rooms": 2, "build_year": 1940,
                    "floor": 1, "nearest_educational_institution": 310.0, "nearest_shop": 170.0,
                    "public_transport_stop": 80.0, "building_type": "Brick", "no_of_floors": 3
                    }]
...
def test_process_input_positive():
    ...
    assert pd.DataFrame(single_input, columns=['division', 'no_of_rooms', 'area', 'floor', 'no_of_floors', 'build_year', 'building_type', 'nearest_kindergarten',
            'nearest_educational_institution', 'nearest_shop', 'public_transport_stop']).equals(result)
...
def test_incomplete_input_negative(app, client):
    ...
    expected = {"Please post data with these headers": ['division', 'no_of_rooms', 'area', 'floor', 'no_of_floors', 'build_year', 'building_type', 'nearest_kindergarten',
...
def test_predict_price():
    ...
    assert price == [{"division": "Baltupiai", "area": 35, "no_of_rooms": 1, "build_year": 2021, "floor": 2,
                      "nearest_kindergarten": 80, "nearest_educational_institution": 170.0, "nearest_shop": 490.0,
                      "public_transport_stop": 240.0, "building_type": "Brick", "no_of_floors": 5,
                      "price_per_month": 311.0}]

def test_negative_predict_price():
    df = pd.DataFrame(single_wrong_input)
